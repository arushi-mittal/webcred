...
def writetodatabse ():
	global url, pagedata, headers, plaintext, links, tld, domain
	client = MongoClient('localhost', 27017)
	db = client.webcred
	collectionfact = db.Fact
	collectiongenre = db.Genre 
	collectionuser = db.User
	linklist = countlinks(links)
	...
	postfact = {
		...
		"internationalized": internationalized(pagedata, headers),
